// 语言
	var LanguageZH, LanguageEN, LanguageUG,lang
	     var LanguageZH ={ 
	    		...
	    		"Mood":"气氛",
	    		"UploadImage":"发送图片",
	    		"EverybodySearching":"大家都在搜",
	    		"SuggestionAndRequests" : "建议和请求",
	    		"ConfirmDelete":"确定删除吗?",
	    		"TypeContentInHere": "在此输入内容",
	    		"SearchHistory":"搜索历史",
	    		"HotSearch":"热门搜索",
	    		"Yes": "是",
	    		"No":"否",
	    	 ...
	    	 var LanguageEN ={ 
	    		...
	    		"SearchDescription": "Search favorite song / singer",
	    		"Close": "Close",
	    		"Retry": "Retry",
	    		...
	    		"EverybodySearching":"Everybody searching",
	    		"SuggestionAndRequests" : "Suggestion And Requests",
	    		"ConfirmDelete":"Confirm Delete?",
	    		"TypeContentInHere": "Type content in here",
	    	 ...
	    	 var LanguageUG ={ 
	    		...
	    		"Mood":"كەيپىيات",
	    		"UploadImage":"رەمىم ئەۋەتىش",
	    		"EverybodySearching":"ھەممەيلەن ئىزدەۋاتقىنى",
	    		"SuggestionAndRequests" : "تەلەپ ۋە پىكىر",
	    		"ConfirmDelete":"ئۆچۈرۈشنى جەزىملەشتۈرەمسىز؟‏",
	    		"TypeContentInHere": "مەزمۇننى بۇ يەرگە كىرگۈزۈڭ",
	    		"SearchHistory":"ئىزدەش تارىخى",
	    		"HotSearch":"ئالقىشلىق ئىزدەش",
	    		"Yes": "ھەئە",
	    		"No":"ياق",
	    		"OK": "ماقۇل",
	    		"Cancel":"ئۆچۈرۈش",
	    		"EmptyData": "~‏مەزمۇنى قۇپقۇرۇق",
	    		 "Send": "ئەۋەتىش"
	    	};
