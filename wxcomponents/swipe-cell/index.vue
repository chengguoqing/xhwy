<template>
<uni-shadow-root class="swipe-cell-index"><view class="van-swipe-cell" data-key="cell" @click.stop.prevent="onClick" @touchstart="startDrag" @touchmove.stop.prevent="catchMove ? 'noop' : ''" @touchmove.capture="onDrag" @touchend="endDrag" @touchcancel="endDrag">
